...
py -m PyInstaller --clean --name 造数工具 --onefile --icon ..\OG.ico --add-data "..\frontend\dist;frontend\dist" --hidden-import uvicorn --hidden-import backend.main --hidden-import main --hidden-import chromadb.telemetry.product.posthog --paths . ..\launcher.py
